...
namespace Universal_Hospital.Controllers
{
    public class DepartamentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DepartamentId,Name,Description,Floor")] Departament departament)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DepartamentId,Name,Description,Floor")] Departament departament)
        {
